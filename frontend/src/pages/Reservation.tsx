...
const Reservation = () => {
  ...
  return (
    <div className={`mx-auto h-screen md:h-auto container fixed left-0 right-0 top-16 mt-1 bg-white lg:w-3/5 ${page === 1 ? 'fade-in' : ''}`}>
      <div className="reservation-container" style={{ maxHeight: '800px', overflowY: 'auto' }}> {/* Adj fix magasságot és overflow tulajdonságot */}
        ...
        {
          page === 2 && (
            <section className={`${page === 2 ? 'fade-in' : ''}`}>
        ...
        {
          page === 3 && (
            <section className={`mt-10 ${page === 3 ? 'fade-in' : ''}`}>
              {selectedReservationDateRange && (
